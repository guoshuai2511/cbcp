...
export class SingleOutSideOverlayConstructor {
        ...
        singleDivOverlay.prototype.initialize = function (map) {
            ...
            div.innerHTML = `
                ...
                <div id="energy-value-${this._devCode}" style="display:${Energy.getEnergyDisplay(this._isHit)}">
                    <div class="energy-word-single energy-word-0-${this._devCode}" style="left:-16px;top:-50px;background:` + Energy.getEnergyColor(this._energy, this._isHit) + `">` + this._energy + `</div><!--前方-->
                <div>
            `;
            /* 将div添加到覆盖物容器中 */
